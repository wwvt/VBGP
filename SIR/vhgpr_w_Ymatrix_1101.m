function [out1, out2, mutst, diagSigmatst, atst, diagCtst]= vhgpr_w_Ymatrix_1101(LambdaTheta, covfunc1, covfunc2, fixhyp, X, y, A, Xtst)
...
% for dataset with Ymatrix structure
 Y = zeros(n,1);
