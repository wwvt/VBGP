...
[y(:,Mreps), Y(:,Mreps), Vhat(:,Mreps)]  = sirSimulate_M2k_w(S0(:,Mreps), I0(:,Mreps), n);
%end

%save('VBGP_rev1_SIR_4+lhs_M2k_cut_data_eq_C1wk20.mat');
% %%
% clear;clc;
...
[ymu, ys2, fmu, fs2, lp, post] = gp_ww(hyp3(:,Mreps), @infGaussLik_ww, meanfunc, covfunc, [], Xdesign, Ydesign(:,Mreps),Vhat(:,Mreps)./n,XKscaled);
sky(:,Mreps) = fmu;
%---------------------VB predict---------------------%
replication = n;
...
save('VBGP_rev1_SIR_4+lhs_M2k_cut_eq_C1w_k20.mat');
