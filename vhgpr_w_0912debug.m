function [out1, out2, mutst, diagSigmatst, atst, diagCtst]= vhgpr_w_0912debug(LambdaTheta, covfunc1, covfunc2, fixhyp, X, y, A, Xtst)
% Last update: 9/12/2018 minimize problems
      ...
      for i = 1:n    
        ...
        %    dBD  = -diag(1./nV) * Rdiaginv *  dRD * Rdiaginv;  %**********************
            ...
            dFLambda(i)= trace(-dBD*BBinv)+ trace(IBKinv*dBD* Kf) + bd * dBD * (1./nV) + ... %% * ones(n,1) 
                       ...
                       (-1)* (ones(n,1)'* Kg  * dDD * ones(n,1)) - 1/2 *trace(Omega * dDD *  Omega);
       end
