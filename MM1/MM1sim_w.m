function [waits Y Vhat] = MM1sim(service_rate, arrival_rate, n, runlength, init)
...
if (service_rate<max(arrival_rate))
    error('Unstable queue.');
end

% k = size(arrival_rate,1); % number of design points
